...
func _build_map():
	...
	# 3️ Treppen vertikal
	graph.add_edge(TreppeS1, W0, 14)
	graph.add_edge(TreppeS1, "W1", 14)
	graph.add_edge(TreppeS1, "W2", 14)
	graph.add_edge(TreppeS1, "W3", 14)
	graph.add_edge(TreppeS2, W0, 14)
	graph.add_edge(TreppeS2, "W1", 14)
	graph.add_edge(TreppeS2, "W2", 14)
	graph.add_edge(TreppeS2, "W3", 14)
	graph.add_edge(TreppeA1, "A0", 14)
	graph.add_edge(TreppeA1, "A1", 14)
	graph.add_edge(TreppeA1, "A2", 14)
	graph.add_edge(TreppeA1, "A3", 14)
	graph.add_edge(TreppeA1, "A4", 14)
	graph.add_edge(TreppeA1, "W0", 14)
	graph.add_edge(TreppeA1, "W1", 14)
	graph.add_edge(TreppeA1, "W2", 14)
	graph.add_edge(TreppeA1, "W3", 14)
	graph.add_edge(TreppeA1, "W4", 14)
	graph.add_edge(TreppeA2, "A0", 14)
	graph.add_edge(TreppeA2, "A1", 14)
	graph.add_edge(TreppeA2, "A2", 14)
	graph.add_edge(TreppeA2, "A3", 14)
	graph.add_edge(TreppeA2, "A4", 14) 
	graph.add_edge(TreppeW1, S0, 14) 
	graph.add_edge(TreppeW1, "S1", 14) 
	graph.add_edge(TreppeW1, "S2", 14) 
	graph.add_edge(TreppeW1, "S3", 14) 
	graph.add_edge(TreppeW1, "S4", 14)  
	graph.add_edge(TreppeW2, S0, 14)
	graph.add_edge(TreppeW2, "S1",14)
	graph.add_edge(TreppeW2, "S2", 14)
	graph.add_edge(TreppeW2, "S3", 14)
	graph.add_edge(TreppeW2, "S4", 14)
